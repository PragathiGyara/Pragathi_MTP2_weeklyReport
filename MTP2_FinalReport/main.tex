...
\begin{titlepage}
    ...
    \begin{center}
      \mbox{}\\
      {\bf\expandafter\uppercase\expandafter{\LARGE Design and In-Situ Evaluation of a Gamified System for Smartphone Use Reduction }} \\[0.6in]
...
\subsection{Features of the application}
\subsection{User Interaction Flow}
\subsection{Competition Logic}
...
\newpage
\section{Evalution/User Study Results}
...
\subsection{Digital Minimalism Limitations}
