...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Define a function which gets all the phone state information using the methods mentioned above.
    \end{enumerate}
  ...
  \begin{lstlisting}[caption={Collecting Phone State and logging},label={label: Collecting Phone State and logging}]
    PhoneStateSnapshot snapshot = PhoneStateCollector.collectPhoneState(context);
...
\begin{enumerate}
    \item SAS-SV reading
    \item MPAI (Mobile Phone Addiction Index) reading
    \item MBT (Mindfulness Based Therapy) reading
    \item Updating original timestamps of counting number of unlocks experiment (case 4)
    \item Updating definitions of 3 methods to find the screen time
\end{enumerate}

\subsection{JODO not accesible in power saving mode}
