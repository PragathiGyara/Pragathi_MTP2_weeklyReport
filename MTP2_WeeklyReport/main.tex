...
\begin{enumerate}
    ...
    \item It also looks at whether incentives and real-world rewards (like discounts and coupons) help in reducing screen time.
    ...
    \item To be eligible for rewards, participants must take part for at least 1 week.
    \item To be eligible for the overall competition, participants must take part for at least 2 weeks.
...
\begin{enumerate}
    ...
    \item Daily screen usage statistics (screen time session wise: , total screen time, unlock count)
    \item logs
\end{enumerate}
...
\subsubsection{Proposed Timeline of Work}
\begin{enumerate}
    \item 30th March - 5th April : 
    \item 5th April - 15th April : Recruitment
    \item 15th April - 20th May : User Study
\end{enumerate}

\subsection{TO DO}
\begin{enumerate}
    \item logs to detect uninstall of the application
    \item Contact or report issues option.
\end{enumerate}
