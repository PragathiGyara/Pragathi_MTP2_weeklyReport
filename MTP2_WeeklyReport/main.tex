...
\begin{enumerate}
    ...
    \item \label{sec: SAS-SV Update} Meta analysis tells us if an intervention is good compared to control group or not. The output of the meta analysis is the SMD (Standard Mean Difference).
    ...
    \begin{enumerate}
        ...
        Though I have calculated drop for some intervention methods based on the sample size and standard deviation reported in the paper to get an high level understanding. Refer \ref{}
...
\subsection{Tasks}
\begin{enumerate}
    \item SAS-SV reading \ref{sec: SAS-SV Update}. \hfill \textbf{[DONE]}
