...
\begin{enumerate}
    ...
    \item \textbf{Cognitive Behavioral Therapy (CBT)} : Based on the cognitive behavioral model. Helps identify the negative or problematic cognition/thought patterns via talk therapy. \cite{}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Event 1 : Move from experiment page (inside app) to launcher screen.
        \item Event 2 : Lock the phone
        \item Event 3 : 
    \end{enumerate}
    \item Results : 
